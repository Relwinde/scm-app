<div>
    <div class="card form-input-elements">
        <div class="card-header justify-content-between">
            <h3 class="mb-0 card-title"><b>Importation du BAE du dossier {{ $dossier->numero }}</b></h3>
        </div>
        <form wire:submit.prevent="save">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 ">
                        <div class="mb-3">
                            <label for="formFile" class="form-label">Entrez le numéro du BAE</label>
                            <input class="form-control" type="text" wire:model="bae_number" required>
                            @error('numero_bae')<div class="error-message"> {{ $message }} </div>@enderror
                        </div>
                    </div>
                    <div class="col-md-6 ">
                        <div class="mb-3">
                            <label for="formFile" class="form-label">Selectionnez le BAE (format PDF)</label>
        ...
        $wire.on('bae-confirmed', () => {
            (function () {
                $(function () {
                    return $.growl({
                        title: "Succès :",
                        message: "Le BAE a été importé avec succès."
                    });
                });
            }).call(this);
        });
