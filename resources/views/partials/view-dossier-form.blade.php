...
<div class="card form-input-elements">
    <div class="card-header d-flex justify-content-between">
        <h3 class="mb-0 card-title"><b>Détail du dossier {{$dossier->numero}}</b><a target="_blank"  href="{{route('print-dossier', $dossier->id)}}" class="btn btn-outline-primary"><i class="fe fe-file me-2 d-inline-flex"></i>Page de garde</a></h3>
        <div class="dropdown">
